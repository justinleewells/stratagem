 ...
 *                      each property that is initialized on the creation of a new unit. Accepted types are:
 *                      'Number', 'String', 'Null', 'Resource', and 'Attribute'.
 * 
 * @property {string[]} unitEvents - An array containing the keys of each event to initialize on
